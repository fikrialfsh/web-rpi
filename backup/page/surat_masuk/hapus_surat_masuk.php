...
if(isset($_GET['id'])){
	...
	$cek = mysql_query("SELECT * FROM tp_arsip_surat_masuk WHERE id_arsip_surat_masuk='$id'") or die(mysql_error());
	...
	if(mysql_num_rows($cek) == 0){
		...
		$del = mysql_query("DELETE FROM tp_arsip_surat_masuk WHERE id_arsip_surat_masuk='$id'");
