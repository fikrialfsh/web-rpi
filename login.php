...
<head>
	...
	<title>Sistem Pengarsipan Dokumen RPI</title>
</head>
<body>
	...
	<?php } ?>
		<div class="login-data">
			<form action="login/validasi_login.php" method="post">
				...
				<div class="login-header">SISTEM INFORMASI PENGARSIPAN DOKUMEN RPI</div>
				<div class="label">
	...
	<div class="footer"><font color="#3366ff">ROBOTIKA POLINDRA</font><p></p>2019</div>
</body>
</html>